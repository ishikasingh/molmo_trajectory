...
def main():
    ...
    examples = [
        ...
        {"image_path": "./temp_test_image/test.jpg", "prompt": "point to the laptop"},
        {"image_path": "./temp_test_image/test.jpg", "prompt": "point to the keyboard"},
        {"image_path": "./temp_test_image/test.jpg", "prompt": "point to the battery charger"},
        {"image_path": "./temp_test_image/test_1.jpeg", "prompt": "point to the yellow die"},
        {"image_path": "./temp_test_image/test_1.jpeg", "prompt": "point to the green basket"},
